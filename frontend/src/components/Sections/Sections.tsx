        ...
        const sectionList: Section[] = [
            {
                ...
                progress: savedProgress["/khai-niem-va-quy-tac"] || 0,
                total: 100,
            ...
            },
            {
                ...
                progress: savedProgress["/van-hoa-va-dao-duc-lai-xe"] || 0,
                total: 10,
            ...
            },
            {
                ...
                progress: savedProgress["/ky-thuat-lai-xe"] || 0,
                total: 15,
            ...
            },
            {
                ...
                progress: savedProgress["/bien-bao-duong-bo"] || 0,
                total: 90,
            ...
            },
            {
                ...
                progress: savedProgress["/sa-hinh"] || 0,
                total: 35,
                link: "sa-hinh",
                icon: (
    ...
    return (
        <div className="container">
            {/* <div className="flex justify-end">
                <button onClick={handleReset} className="mb-4 bg-blue-500 hover:bg-blue-600 p-1.5 rounded-xl text-white">Xóa lịch sử ôn tập</button>
            </div> */}
