...
const Review = () => {
    ...
    const loadMcQuestions = async () => {
        ...
        try {
            ...
            console.log("path la: " + pathType);
            const { data } = await mcQuestionApi.getMcQuestionsByType(pathType);
            setMcQuestions(data);
                        ...
                        <div className="grid grid-cols-8 md:grid-cols-4 xl:grid-cols-5 gap-2 overflow-y-auto max-h-96">
                            {mcQuestions.map((question, index) => (
                                ...
                                >
                                    ...
                                    {selectedAnswers[mcQuestions[question.questionNumber - 1].questionNumber] === mcQuestions[question.questionNumber - 1].answer ? (
                                    ...
                                    ) : selectedAnswers[mcQuestions[question.questionNumber - 1].questionNumber] !== mcQuestions[question.questionNumber - 1].answer && selectedAnswers[mcQuestions[question.questionNumber - 1].questionNumber] != null ? (
